...
Partial Class ForgotPage
    ...
    Private Sub InitializeComponent()
        ...
        Label1.Location = New Point(363, 10)
        Label1.Name = "Label1"
        ...
        Label2.Location = New Point(184, 395)
        Label2.Name = "Label2"
        ...
        txtemail.Location = New Point(195, 453)
        txtemail.Name = "txtemail"
        txtemail.Size = New Size(534, 53)
        txtemail.TabIndex = 2
        ' 
        ' Label3
        ' 
        ...
        Label3.Font = New Font("Georgia", 12F, FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        Label3.Location = New Point(195, 511)
        Label3.Name = "Label3"
        ...
        ' BtnResetPassword
        ' 
        BtnResetPassword.BackColor = Color.DarkOliveGreen
        ...
        BtnResetPassword.Location = New Point(394, 591)
        ...
        BtnBack.Location = New Point(1674, 909)
        BtnBack.Name = "BtnBack"
        BtnBack.Size = New Size(161, 76)
        BtnBack.TabIndex = 5
        BtnBack.Text = "Back"
