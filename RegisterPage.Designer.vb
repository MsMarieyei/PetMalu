...
Partial Class RegisterPage
    ...
    Private Sub InitializeComponent()
        ...
        Label2.Font = New Font("Britannic Bold", 24F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label2.ForeColor = Color.FromArgb(CByte(0), CByte(64), CByte(64))
        Label2.Location = New Point(663, 306)
        Label2.Name = "Label2"
        ...
        Label3.Location = New Point(741, 389)
        Label3.Name = "Label3"
        ...
        Label4.Location = New Point(668, 473)
        Label4.Name = "Label4"
        ...
        Label5.Location = New Point(726, 558)
        Label5.Name = "Label5"
        ...
        ' BtnRegister
        ' 
        BtnRegister.BackColor = Color.DarkOliveGreen
        BtnRegister.FlatStyle = FlatStyle.Popup
        BtnRegister.Font = New Font("Cambria", 16.2F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        BtnRegister.ForeColor = Color.White
        BtnRegister.Location = New Point(1058, 656)
        BtnRegister.Name = "BtnRegister"
        BtnRegister.Size = New Size(168, 49)
        ...
        txtname.Location = New Point(886, 296)
        ...
        txtemail.Location = New Point(886, 379)
        ...
        txtpassword.Location = New Point(886, 463)
        ...
        txtphone.Location = New Point(886, 548)
        ...
        BtnBack.Location = New Point(1537, 816)
        BtnBack.Name = "BtnBack"
        BtnBack.Size = New Size(163, 74)
        BtnBack.TabIndex = 10
        BtnBack.Text = "Back"
