...
Public Class PetRegistrationPage
    ...
    Private Sub BtnSubmit_Click(sender As Object, e As EventArgs) Handles BtnSubmit.Click
        ...
        Dim Suggestions1 As String = TxtBreed.Text
        ...
        If String.IsNullOrEmpty(PetID) OrElse String.IsNullOrEmpty(Name) OrElse String.IsNullOrEmpty(Color) OrElse String.IsNullOrEmpty(Suggestions1) Then
        ...
        Try
            Using connection As New MySqlConnection(connectionString)
                ...
                ' Insert Pet Info
                Dim query As String = "INSERT INTO pets_info (PetID, Name, Sex, Birthday, Type, Breed, Color, HasSurgery) VALUES (@PetID, @Name, @Sex, @Birthday, @Type, @Breed, @Color, @HasSurgery)"
                ...
                If RbtnYesVac.Checked Then
                    For Each item As String In CheckedVaccine.CheckedItems
                        ...
                        If vaccineID IsNot Nothing Then
                            Dim vaccineQuery As String = "INSERT INTO PetVaccinations (PetID, VaccineID, VaccinationDate) VALUES (@PetID, @VaccineID, CURDATE())"
                ...
                If RbtnYesDeworm.Checked Then
                    For Each item As String In CheckedDeworming.CheckedItems
                        Dim dewormingQuery As String = "INSERT INTO PetDewormings (PetID, DewormingID, DewormingDate) VALUES (@PetID, (SELECT DewormingID FROM Dewormings WHERE Name = @Deworming), CURDATE())"
                ...
                If RbtnYes.Checked Then
                    For Each item As String In CheckedSurgery.CheckedItems
                        Dim surgeryQuery As String = "INSERT INTO PetSurgeries (PetID, SurgeryType, SurgeryDate) VALUES (@PetID, @SurgeryType, CURDATE())"
...
"Copper", "Steel"})
    ...
    Private Sub SaveImageToDatabase(imgBytes As Byte())
        ...
        Using conn As New MySqlConnection(connectionString)
            Dim query As String = "UPDATE pets_info SET Photo = @Photo WHERE PetID = @PetID"
            Using cmd As New MySqlCommand(query, conn)
                cmd.Parameters.AddWithValue("@Photo", imgBytes)
                cmd.Parameters.AddWithValue("@PetID", TxtPetIDNo.Text) ' Replace with dynamic PetID input
                ...
                Else
                    MessageBox.Show("❌ Error: No rows updated. Check PetID.")
                End If
            End Using
        End Using
    End Sub
